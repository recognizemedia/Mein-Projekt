...
Dieses Repository ist der Arbeitsbereich für Kundenprojekte, die sich hauptsächlich um zwei Themenfelder drehen:
...
8. Kurze Sätze von im Schnitt sechs bis neun Wörtern sind eine Faustregel, keine feste Vorgabe. Auch längere Sätze sind erlaubt, dann aber mit regelmäßigen Satzzeichen (Punkt oder Komma) gliedern, damit der Text leserlich bleibt und persönlich klingt.

## Wie du arbeiten sollst

- Antworte immer auf Deutsch.
- Bevor du Code änderst, frage kurz um Erlaubnis.
- Erkläre Änderungen kurz und knapp.
